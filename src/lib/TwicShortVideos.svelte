  ...
  <TwicWrapper filename="src/lib/TwicShortVideos.svelte">
    <TwicAbstract title="Short Videos">
        <p>
          ...
          <p>
            The TwicVideo component automatically handles CLS, LQIP and the display
            of a generated poster until the video is actually viewable.
          </p>
          <p>
            The TwicPics API features three transformations that can be used to <a href="https://www.twicpics.com/docs/topics/video-optimization#video-slicing?utm_source=github&utm_medium=organic&utm_campaign=components#svelte3" target="_blank" rel="noreferrer">extract a portion of the original video</a>.
          </p>
          <br />
          ...
          <ul>
            <li>
              ...
              <span>
                used to extract a portion of the original video.
              </span>
            </li>
            <li>
              <Code>intrinsic</Code>:
            ...
            <li>
              <Code>preTransform</Code>:<span
                >allows to perfom <a href="https://www.twicpics.com/docs/reference/transformations?utm_source=github&utm_medium=organic&utm_campaign=components#svelte3" target="_blank" rel="noreferrer">TwicPics API transformations</a>.</span
              >
            </li>
            <li>
              <Code>ratio</Code>:
